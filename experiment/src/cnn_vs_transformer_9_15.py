...
def save_result_plot(
    ...
    ax_score.plot(indices, cnn_scores, label="CNN", linewidth=1.0, alpha=0.5)
    ax_score.plot(indices, transformer_scores, label="Transformer", linewidth=1.0, alpha=0.5)
...
def build_output_stem(
    ...
    return (
        ...
        f"_score_datasize{data_size}_x{x_repeats}"
    )
