...
@click.command()
@click.option('--model-name', type=click.STRING, default="cai75000CP-32-9-LeaRate000-vx32-vy25-batchsize512", help="保存するモデルの名前の指定")
...
def train_main(model_name: str, use_gpu: bool):
    ...
    generate_supervised_learning_data(program_dir, log_dir, data_size=75000)
    # return
    if use_gpu:
