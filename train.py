...
@click.command()
@click.option('--model-name', type=click.STRING, default="transformer-sl-9-14-model-06-15-adamw-epoch50-shot-use_score_diff_augmentation=True", help="保存するモデルの名前の指定")
@click.option('--use-gpu', type=click.BOOL, default=True, help="GPUの使用")
